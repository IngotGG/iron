 ...
 * @see [SuspendingStatementExecutor.queryMapped]
 * @since 1.0
 */
 ...
 * @see [SuspendingStatementExecutor.prepareMapped]
 * @since 1.0
 */
@JvmName("prepareMappedInline")
suspend inline fun <reified T: Any> SuspendingStatementExecutor.prepareMapped(@Language("SQL") statement: String, vararg values: Any): MappedResultSet<T> {
